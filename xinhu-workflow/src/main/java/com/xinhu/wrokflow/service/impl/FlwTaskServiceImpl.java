...
import com.xinhu.common.core.domain.dto.StartProcessReturnDTO;
...
import com.xinhu.common.utils.JsonUtils;
import com.xinhu.common.utils.StreamUtils;
import com.xinhu.common.utils.StringUtils;
import com.xinhu.common.utils.ValidatorUtils;
import com.xinhu.wrokflow.common.ConditionalOnEnable;
import com.xinhu.wrokflow.common.constant.FlowConstant;
import com.xinhu.wrokflow.common.enums.TaskAssigneeType;
import com.xinhu.wrokflow.common.enums.TaskStatusEnum;
import com.xinhu.wrokflow.domain.FlowInstanceBizExt;
import com.xinhu.wrokflow.domain.bo.*;
import com.xinhu.wrokflow.domain.vo.FlowCopyVo;
import com.xinhu.wrokflow.domain.vo.FlowHisTaskVo;
import com.xinhu.wrokflow.domain.vo.FlowTaskVo;
import com.xinhu.wrokflow.domain.vo.NodeExtVo;
import com.xinhu.wrokflow.mapper.FlwCategoryMapper;
import com.xinhu.wrokflow.mapper.FlwInstanceBizExtMapper;
import com.xinhu.wrokflow.mapper.FlwTaskMapper;
import com.xinhu.wrokflow.service.IFlwCommonService;
import com.xinhu.wrokflow.service.IFlwNodeExtService;
import com.xinhu.wrokflow.service.IFlwTaskAssigneeService;
import com.xinhu.wrokflow.service.IFlwTaskService;
...
import static com.xinhu.wrokflow.common.constant.FlowConstant.*;
    ...
    private void skipTask(Long taskId, FlowParams flowParams, Long instanceId, Boolean autoPass) {
        ...
        for (FlowTask task : flowTaskList) {
            if (!task.getId().equals(taskId) && autoPass) {
                ...
                flowParams.
                    message("流程引擎自动审批！").
                    variable(Collections.unmodifiableMap(new HashMap<String, Object>() {{
                        put(FlowConstant.SUBMIT, false);
                        put(FlowConstant.FLOW_COPY_LIST, Collections.emptyList());
                        put(FlowConstant.MESSAGE_NOTICE, StringUtils.EMPTY);
                    }}));
