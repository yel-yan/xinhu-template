  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>xinhu-Vue-Plus后台管理系统</h2>
        <p>
          xinhu-Vue-Plus 是基于 xinhu-Vue 针对 分布式集群 场景升级(不兼容原框架)
          <br/>
        ...
        <p>
          <el-button
            ...
            icon="Cloudy"
            plain
            @click="goTarget('https://gitee.com/JavaLionLi/xinhu-Vue-Plus')"
            >访问码云</el-button
          >
          <el-button
            type="primary"
            icon="Cloudy"
            plain
            @click="goTarget('https://github.com/JavaLionLi/xinhu-Vue-Plus')"
            >访问GitHub</el-button
          >
          <el-button
            type="primary"
            icon="Cloudy"
            plain
            @click="goTarget('https://gitee.com/JavaLionLi/xinhu-Vue-Plus/wikis/pages?sort_id=4106467&doc_id=1469725')"
          >更新日志</el-button
          >
        </p>
      </el-col>
