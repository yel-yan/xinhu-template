...
import com.xinhu.common.enums.BusinessStatusEnum;
...
import com.xinhu.workflow.common.enums.TaskStatusEnum;
import com.xinhu.workflow.domain.bo.FlowCancelBo;
import com.xinhu.workflow.domain.bo.FlowInstanceBo;
import com.xinhu.workflow.domain.bo.FlowInvalidBo;
import com.xinhu.workflow.domain.bo.FlowVariableBo;
import com.xinhu.workflow.domain.vo.FlowHisTaskVo;
import com.xinhu.workflow.domain.vo.FlowInstanceVo;
import com.xinhu.workflow.handler.FlowProcessEventHandler;
import com.xinhu.workflow.mapper.FlwCategoryMapper;
import com.xinhu.workflow.mapper.FlwInstanceMapper;
import com.xinhu.workflow.service.IFlwInstanceService;
...
public class FlwInstanceServiceImpl implements IFlwInstanceService {
     ...
     */
    @Override
    public TableDataInfo<FlowInstance> selectFinishInstanceList(FlowInstanceBo flowInstanceBo, PageQuery pageQuery) {
        QueryWrapper<FlowInstance> queryWrapper = buildQueryWrapper(flowInstanceBo);
     ...
     * @return 查询条件构造方法
     */
    private QueryWrapper<FlowInstance> buildQueryWrapper(FlowInstanceBo flowInstanceBo) {
        QueryWrapper<FlowInstance> queryWrapper = Wrappers.query();
     ...
     */
    @Override
    public TableDataInfo<FlowInstance> selectCurrentInstanceList(FlowInstanceBo instanceBo, PageQuery pageQuery) {
        QueryWrapper<FlowInstance> queryWrapper = buildQueryWrapper(instanceBo);
    ...
    public void updateStatus(Long instanceId, String status) {
        ...
        flowInstanceMapper.update(null,wrapper);
    }
    ...
    public Map<String, Object> instanceVariable(Long instanceId) {
        ...
        return new HashMap<String, Object>() {{
            put("variableList", variableList);
            put("variable", flowInstance.getVariable());
        }};
    }
