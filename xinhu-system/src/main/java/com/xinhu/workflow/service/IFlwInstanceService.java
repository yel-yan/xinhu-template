package com.xinhu.workflow.service;
...
public interface IFlwInstanceService {
     ...
     * @return 结果
     */
    TableDataInfo<FlowInstance> selectRunningInstanceList(FlowInstanceBo flowInstanceBo, PageQuery pageQuery);
     ...
     * @return 结果
     */
    TableDataInfo<FlowInstance> selectFinishInstanceList(FlowInstanceBo flowInstanceBo, PageQuery pageQuery);
     ...
     * @return 结果
     */
    TableDataInfo<FlowInstance> selectCurrentInstanceList(FlowInstanceBo instanceBo, PageQuery pageQuery);
