...
#启动监控模块
monitor(){
    docker-compose up -d xinhu-monitor-admin
}

#启动程序模块
start(){
    docker-compose up -d xinhu-xxl-job-admin xinhu-server1 xinhu-server2
}

#停止程序模块
stop(){
    docker-compose stop xinhu-xxl-job-admin xinhu-server1 xinhu-server2
}
